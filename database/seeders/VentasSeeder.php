...
class VentasSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $productos->nombreproducto = "Alcohol 90º 750ml";
        ...
        $productos = new Productos();
        $productos->nombreproducto = "Alcohol Gel Savon 500ml";
        ...
        $productos = new Productos();
        $productos->nombreproducto = "AERIUS 5MG X 1 TABLETA";
        ...
        $productos = new Productos();
        $productos->nombreproducto = "AMOXICILINA L.S. 500MG X 1 CAPSULA";
        ...
        $productos = new Productos();
        $productos->nombreproducto = "LORATADINA LS 10MG X 1 TABLETA";
        ...
        $productos = new Productos();
        $productos->nombreproducto = "ACIMED 15MG X 1 SOBRE DE 2 CAPSULAS";
        ...
        $productos = new Productos();
        $productos->nombreproducto = "ABRILAR JARABE FRASCO X 100 ML";
        ...
        $productos = new Productos();
        $productos->nombreproducto = "Mascarilla KN95 Unidad";
